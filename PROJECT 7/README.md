...
provision 3 EC2 instance, two will of these will be our webserver and one will be a load balaner
...
### Step 2: 
 ...
 Open New Security Group For Both Webservers and load balancer
...
### Step 5:
 ...
 Configure Apache to Show Names Of Both Webservers

In the previous step, we set up a new listen directive and virtualhost statement. In our "000-default.conf", the document root is 

located at /var/www/html. We need to change the content of the file in our document root to show the name of our webserver.
